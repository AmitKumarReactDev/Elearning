                ...
                foreach ($list as $row) 
                {
                  ...
                  <tr>
                    ...
                    <?php
                        ...
                        ?>
                    <td>
                      <a href="<?php echo site_url() ?>/subject/activedeactive/<?php echo $row['subject_id'] ?>" class="btn btn-block btn-danger"><?php echo $row['subject_status'] ?></a>
                    </td>                      
                       <?php
                      }
                      ?>
                        <td><?php echo $row['subject_entry_time'] ?></td>
                        <td><?php echo $row['subject_update_time'] ?></td>
                  </tr>
                  <?php
                }
               ?>
