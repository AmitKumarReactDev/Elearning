...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url() ?>/coursematerial/add">View Material</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form enctype="multipart/form-data" data-parsley-validate="" role="form" method="post" action="<?php echo site_url() ?>/coursematerial/addrow" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                 <label form="exampleInputEmail1">Material Title</label>
                  <input type="text" class="form-control" name="materialtitle" id="exampleInputEmail1" placeholder="Enter Title">
                </div>
               <div class="form-group">
                 <label form="exampleInputEmail1">Material Description</label>
                  <input type="text" class="form-control" name="materialdesc" id="exampleInputEmail1" placeholder="Enter Description">
                </div>
                <div class="form-group">
