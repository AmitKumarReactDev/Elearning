...
<!-- <div class="alert alert-danger alert-dismissible">
 ...
 <!-- /.login-logo -->
  ...
  <div class="login-box-body">
    ...
    <form data-parsley-validate="" action="<?php echo site_url() ?>/login/ForgetPassword" method="post">
      ...
      <div class="row">
        <div class="col-xs-4">
          <button style="float:left;"   type="submit" class="btn btn-primary btn-block btn-flat">Send OTP</button> 
        </div>
        <!-- /.col -->
      </div>
    </form>
