                ...
                foreach ($examlist as $row) 
                {
                  ...
                  <tr>
                    <?php
                      ...
                      { ?>
                        <td><a style="color:grey; opacity:0.6;" onclick="return confirm('are you sure')" href="<?php echo site_url() ?>/faculty/examedit/<?php echo $row['exam_id'] ?>"><i class="glyphicon glyphicon-edit"></i></a></td>
                      <?php
                      }
                      else
                      {
