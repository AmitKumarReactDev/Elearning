      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo site_url() ?>/courseexam/examupdate/<?php echo $selectexam['exam_id']?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  {    
                    ...
                    if($selectexam['pcourse_id'] == $row['pcourse_id']) {
                      ?>
                       <option selected="" value="<?php echo $row['pcourse_id'] ?>"><?php echo $row['pcourse_name'] ?>
                       </option>
