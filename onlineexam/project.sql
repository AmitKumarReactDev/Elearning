...
INSERT INTO `examadmin` (`eadmin_id`, `email`, `password`) VALUES
(1, 'sunnygkp10@gmail.com', '123456'),
(2, 'admin@admin.com', 'eadmin');
...
--
-- Indexes for table `eadmin`
--
ALTER TABLE `eadmin`
  ADD PRIMARY KEY (`eadmin_id`);
...
--
ALTER TABLE `eadmin`
  MODIFY `eadmin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
