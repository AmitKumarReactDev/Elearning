  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="<?php echo base_url() ?>/Admin/image/CoursePhoto/<?php echo $courselist['p_course_photo'] ?>" class="img-fluid w-80">
      </div>
    </div>
    <!-- course info -->
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p><?php echo $courselist['faculty_cdesc'] ?></p>
      </div>
      <div class="col-12 mb-4">
      ...
      <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="media mb-2 mb-sm-0">
            <img class="mr-4 img-fluid" src="<?php echo base_url()?>/Admin/image/CoursePhoto/<?php echo $courselist['p_course_photo'] ?>" alt="Teacher">
            <div class="media-body">
              <h4 class="mt-0"><?php echo $courselist['faculty_name'] ?></h4>
            </div>
          </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="<?php echo base_url()?>/images/courses/course-1.jpg" alt="course thumb">
          <div class="card-body">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="<?php echo base_url()?>/images/courses/course-2.jpg" alt="course thumb">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>
              <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="<?php echo base_url()?>/images/courses/course-3.jpg" alt="course thumb">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>
              <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>
