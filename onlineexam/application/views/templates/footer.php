...
<div class="col-md-3 box">
<a href="<?php echo site_url()?>/feedback.php" target="_blank">Feedback</a></div></div>
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="<?php echo base_url() ?>/image/CAM00121.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
     </div>
     <div class="col-md-5">
