  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 mb-5">
        <img class="img-fluid w-100" src="<php echo base_url() ?>/images/teachers/teacher-1.jpg" alt="teacher">
      </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="<php echo base_url() ?>/images/courses/course-4.jpg" alt="course thumb">
          <div class="card-body">
