      ...
      <div class="col-12">
        ...
        <ul class="list-inline text-center filter-controls mb-5">
           <?php
            ...
            {
              ?>            
              <li class="list-inline-item m-3 text-uppercase" data-filter=""><a href="<?php echo site_url()?>/faculty/pcoursedetail/<?php echo $row['pcourse_id'] ?>"><?php echo $row['pcourse_name']?></a></li>
          <?php 
            }
          ?>
        </ul>
     ...
     <?php
      foreach ($list as $row) 
      {
        ...
        <div class="card border-0 rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" height="350" width="250" src="<?php echo base_url() ?>/Faculty/FacultyPhoto/<?php echo $row['faculty_photo'] ?>" alt="teacher">
          <div class="card-body">
