<footer class="main-footer">
    ...
    <strong style="color:blue;">Copyright &copy; 2014-2019 </strong><span  style="color:black"> All rights
    reserved.</span>
  </footer>
  ...
  $(document).ready(function () {
    ...
    $('#state').change(function(){
      state_id = $('#state').val();
        ...
        {
          $.ajax({
            url:"<?php echo base_url().'index.php/city/add' ?>",
            method:"POST",
...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Nov 2019 06:44:38 GMT -->
</html>
