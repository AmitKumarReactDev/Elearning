                ...
                <tr>
                  <th>exam Status</th>
                   <?php
                      ...
                      { ?>
                    <td>
                      <a href="<?php echo site_url() ?>/exam/activedeactive/<?php echo $list['exam_id'] ?>" class="btn btn-block btn-success">
                    ...
                    <?php
                        ...
                        ?>
                    <td>
                      <a href="<?php echo site_url() ?>/exam/activedeactive/<?php echo $list['exam_id'] ?> " class="btn btn-block btn-danger"><?php echo $list['question_status'] ?></a>
                    </td>                      
                       <?php
                      }
                      ?>
                    ...
                    <tr>
                       <td><a href="<?php echo site_url()?>/exam">go to back</a></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
