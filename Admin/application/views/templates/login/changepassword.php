...
<div class="alert alert-danger alert-dismissible">
 ...
 <!-- /.login-logo -->
  ...
  <div class="login-box-body">
    ...
    <form data-parsley-validate="" action="<?php echo site_url() ?>/login/changepassword" method="post">
      <div class="form-group has-feedback">
        <input type="password" required="" class="form-control" placeholder="enter a password" name="password">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" required="" class="form-control" placeholder="enter a retype a password" name="cpassword">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-4">
